      ...
      <div className="bg-academia-dark rounded-2xl shadow-2xl border border-academia max-w-2xl w-full max-h-[90vh] overflow-y-auto">
        ...
        <form onSubmit={handleSubmit} className="p-8 space-y-8">
          ...
          <div className="flex justify-end gap-4 pt-8 border-t border-academia">
            ...
            <button
              type="submit"
              className="px-8 py-3 bg-academia-green text-academia-light rounded-xl hover:bg-academia-green/80 transition-all duration-300 flex items-center gap-3 font-heading font-semibold border border-academia-green/30 shadow-lg hover:shadow-academia-green/20"
            >
              <Plus size={22} />
              Add Volume
            </button>
